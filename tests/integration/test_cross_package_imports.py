...
This test imports every cross-package module that 'scitex-resource' references
...
def test_cross_package_import(module_name):
    """Importing scitex-resource's declared cross-package dependency must succeed."""
