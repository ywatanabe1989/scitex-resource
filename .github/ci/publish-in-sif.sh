...
# (project=scitex-resource, owner=ywatanabe1989, repo=scitex-resource,
...
TMPDIR="/tmp/publish-scitex_resource-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-resource dist/* uploaded to PyPI via manual OIDC trusted publishing"
